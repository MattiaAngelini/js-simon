...
///////START///////
//creo prima funzione che genera 5 numeri casuali.
let fiveCasualNumbers = generaNumeriCasualiUnici();
console.log(fiveCasualNumbers);
...
function generaNumeriCasualiUnici(numbers) {
    let uniqueNumbers = [];
